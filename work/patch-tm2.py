#!/usr/bin/env python3
"""Apply the remaining security-review fixes to omarchy-time-machine.

F1 (jq --rawfile) is already applied. This script applies F3 (redaction,
corrected after live-testing the original sed), F2 (unit value validation),
F5a/F5b (open_log + restore target), the README updates and the test changes.
All old/new blocks are raw strings so backslashes arrive literally.
"""
import sys
...
# --- F3: redaction (corrected after live-testing the original) ----------------
rep(BIN,
